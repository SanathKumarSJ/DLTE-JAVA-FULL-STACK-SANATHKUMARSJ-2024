 ...
 * 
 */
@WebServiceClient(name = "EmployeePortService", targetNamespace = "http://employee.services", wsdlLocation = "http://localhost:8081/emprepo/Employee.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8081/emprepo/Employee.wsdl");
