 ...
 * 
 */
@WebServiceClient(name = "EmployeeServiceService", targetNamespace = "http://employee.org/", wsdlLocation = "http://localhost:2345/employee?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICESERVICE_QNAME = new QName("http://employee.org/", "EmployeeServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:2345/employee?wsdl");
    ...
    public EmployeeService getEmployeeServicePort() {
        return super.getPort(new QName("http://employee.org/", "EmployeeServicePort"), EmployeeService.class);
    }
    ...
    public EmployeeService getEmployeeServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://employee.org/", "EmployeeServicePort"), EmployeeService.class, features);
    }
