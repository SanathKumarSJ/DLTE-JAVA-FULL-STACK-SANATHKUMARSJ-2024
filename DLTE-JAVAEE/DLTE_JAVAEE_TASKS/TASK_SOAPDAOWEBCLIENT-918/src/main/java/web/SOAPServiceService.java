 ...
 * 
 */
@WebServiceClient(name = "SOAPServiceService", targetNamespace = "http://web/", wsdlLocation = "http://localhost:1231/dao?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICESERVICE_QNAME = new QName("http://web/", "SOAPServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1231/dao?wsdl");
    ...
    public SOAPService getSOAPServicePort() {
        return super.getPort(new QName("http://web/", "SOAPServicePort"), SOAPService.class);
    }
    ...
    public SOAPService getSOAPServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://web/", "SOAPServicePort"), SOAPService.class, features);
    }
