...
<%
    List<Transaction> transactions =(List<Transaction>) request.getAttribute("myTransaction");
    pageContext.setAttribute("myTransactions",transactions,pageContext.APPLICATION_SCOPE);
%>
<div class="container">
