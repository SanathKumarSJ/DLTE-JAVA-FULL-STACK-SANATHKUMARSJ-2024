...
public class SOAPService {
    ...
    public void createTransaction(@WebParam(name = "Username") Transaction transaction){userServices.callSaveTransaction(transaction);}
    ...
    public GroupTransaction readAllTransaction(){
        GroupTransaction constructList=new GroupTransaction();
        List<Transaction> myTransaction = userServices.callFindAllTransaction();
        constructList.setTransactions(myTransaction);
