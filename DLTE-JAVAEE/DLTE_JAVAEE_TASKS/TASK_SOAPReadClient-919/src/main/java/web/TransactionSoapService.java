 ...
 * 
 */
@WebServiceClient(name = "TransactionSoapService", targetNamespace = "http://web/", wsdlLocation = "http://localhost:1212/transaction?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:1212/transaction?wsdl");
